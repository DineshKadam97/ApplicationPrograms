...
// Description :        Reverses each element of singly linear linked list.
// Author Name :        Dinesh Devidasrao Kadam
// Date :               15 June 2023
//
///////////////////////////////////////////////////////////////////////////////////////////////////////

void DisplayReverseDigits(PNODE Head)
{
    int iDigit = 0;
    int iReverse = 0;
    int iNo = 0;
...
int main()
{
    ...
    DisplayReverseDigits(First);                           //Addition of even elements
