/////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Problem Statement : Write a program which returns largest element from singly linear 
//                     linked list.
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
// Function Name :      SearchLargest
// Input :              Structure Pointer   
// Output :             Integer
// Description :        Finds largest element from singly linear linked list.
// Author Name :        Dinesh Devidasrao Kadam
// Date :               15 June 2023
//
///////////////////////////////////////////////////////////////////////////////////////////////////////

int SearchLargest(PNODE Head)
{
    int iMax = Head->data;
...
int main()
{
    ...
    iRet = SearchLargest(First);                          // function call to Search largest element
    printf("Largest element of all the elements is : %d \n \n", iRet);
