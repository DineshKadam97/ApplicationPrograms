...
void HalfSection :: createHalfSection(std::vector<Triangle>& triangles, Point3D mCenter, double offset)
{
  ...
  wobj.write("D:\\Dinesh\\Sketcher2\\TextFiles\\disect1.txt",H_Triangles1);
  wobj.write("D:\\Dinesh\\Sketcher2\\TextFiles\\disect2.txt",H_Triangles2);
}