///////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Problem Statement : Write a program which display products of all digits of elements of singly 
//                     linear linked list.                    
//
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Description :        Multiply digits and display product of each element of singly linear linked list.
// Author Name :        Dinesh Devidasrao Kadam
// Date :               15 June 2023
//
///////////////////////////////////////////////////////////////////////////////////////////////////////

void MultiplyDigits(PNODE Head)
{
    int iDigit = 0;
    int iMult = 1;
    int iNo = 0;
    ...
    while(Head != NULL)
    {
        ...
        printf("Multiplication of the digits of %d is : %d \n \n", Head->data, iMult);
...
int main()
{
    ...
    MultiplyDigits(First);                           //Multiplication of all the digits of a 
